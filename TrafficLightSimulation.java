...
public class TrafficLightSimulation implements Runnable {
    ...
    public void stopSimulation() {
        if (animation != null) {
            ...
            controlPanel.setDensityEnabled(true);
            repaintUI();
        }
    }

    public void updateTimer(int value) {
        controlPanel.setTimer(value);
    }
...
class ControlPanel extends JPanel {
    ...
    private JComboBox<TrafficDensity> densityBox;
    ...
    public ControlPanel(TrafficLightModel model, TrafficLightSimulation frame) {
        ...
        densityBox = new JComboBox<>(TrafficDensity.values());
        ...
        RoundedButton start = new RoundedButton("START", new Color(39,174,96));
        RoundedButton stop = new RoundedButton("STOP", new Color(192,57,43));
        RoundedButton emergency = new RoundedButton("EMERGENCY", new Color(243,156,18));
        ...
        add(statusLabel);
        add(Box.createVerticalStrut(20));
        add(new JLabel("Traffic Density"));
    ...
    public void setTimer(int value) {
        if (value == -1) {
            timerLabel.setText(timerLabel.getText().isBlank() ? "WAIT!" : " ");
        } else {
            timerLabel.setText(value > 0 ? value + " s" : " ");
        }
    }
